...
void rocksdb_options_set_bottommost_compression_options_zstd_use_dict_trainer(
    rocksdb_options_t* opt, unsigned char use_zstd_dict_trainer, unsigned char enabled) {

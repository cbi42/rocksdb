...
TransactionBaseImpl::TransactionBaseImpl(
  ...
  // TODO: overwrite keys can be incorrect with singledelete?
      write_batch_(std::make_shared<WriteBatchWithIndex>(cmp_, 0, true, 0, write_options.protection_bytes_per_key)),

...
class DBTestBase : public testing::Test {
 ...
 public:
  ...
  int NumTableFilesAtLevel(int level, ColumnFamilyHandle* column_family, DB* db = nullptr);
  ...
  void MoveFilesToLevel(int level, ColumnFamilyHandle* column_family, DB* db = nullptr);

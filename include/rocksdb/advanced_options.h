...
struct CompressionOptions {
  ...
  // dictionary generator. If the use_zstd_dict_trainer option is true, zstd's
  // dictionary trainer is used, otherwise zstd's finalizeDictionary API is
  // used as the dictionary generator. If `zstd_max_train_bytes` is zero,
  // the random samples are used directly as the dictionary.
  //
  ...
  // Use ZSTD trainer to generate dictionaries. When set to true, zstd_max_train_bytes
  // of training data sampled from max_dict_buffer_bytes buffered data will be passed to
  // ZSTD dictionary trainer to generate a dictionary of size max_dict_bytes.
  //
  // When this option is false, ZSTD_finalizeDictionary API will be used to generate dictionaries.
  // zstd_max_train_bytes sample data will be passed to this API.
  // Using this API should save CPU time, but the compression ratio may not be as good as using a dictionary trainer.
  //
  // Default: true

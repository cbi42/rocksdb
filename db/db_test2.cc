  ...
  for (auto compression_type : compression_types) {
    ...
    for (int i = kWithoutDict; i < kDictEnd; i++) {
      ...
      if (i == kWithDict) {
        ...
        // dictionary does not get as good a compression ratio as raw content dictionary.
        // But using a dictionary should always get better compression ratio than not using one.
